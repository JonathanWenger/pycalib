...
# Path
sys.path.insert(0, os.path.abspath('../../../pycalib'))
...
latex_documents = [
    (master_doc, 'pycalib.tex', 'pycalib\'s Documentation',
     'Jonathan Wenger', 'manual'),
]
...
man_pages = [
    (master_doc, 'pycalib', 'pycalib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pycalib', 'pycalib\'s Documentation',
     author, 'pycalib', 'One line description of project.',
     'Miscellaneous'),
]
