...
if __name__ == "__main__":
    ...
    # Setup
    file = "/Users/jwenger/Documents/research/projects/nonparametric_calibration/code/pycalib/data/kitti/"
    ...
    kitti_benchmark = pycalib.benchmark.KITTIBinaryData(run_dir=run_dir, data_dir=data_dir,
                                                        ...
                                                        n_splits=10, test_size=8000,
                                                        train_size=1000, random_state=random_state)

    # Run
    kitti_benchmark.run(n_jobs=1)
