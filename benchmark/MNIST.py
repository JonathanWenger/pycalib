...
if __name__ == "__main__":
    ...
    # Setup
    file = "/Users/jwenger/Documents/university/theses/master's thesis/code/pycalib/data/mnist/"
    ...
    cal_methods = {
        ...
        "GPcalib": calm.GPCalibration(n_classes=10, maxiter=1000,
                                      n_inducing_points=10, random_state=random_state),
        "GPcalib_lin": calm.GPCalibration(n_classes=10, maxiter=1000, mean_function=meanfunc, kernel=k,
